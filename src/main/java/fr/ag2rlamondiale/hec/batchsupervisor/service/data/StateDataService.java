...
public class StateDataService {
    ...
    private final List<BatchState> statesToSave = new ArrayList<>();
    ...
    public List<BatchState> loadLastStateForEachBatch(){
        if(this.lastStateForEachBatch == null){
            ...
            this.lastStateForEachBatch = Objects.requireNonNull(stateReaderClient
    ...
    public BatchState getLastSaved(){
